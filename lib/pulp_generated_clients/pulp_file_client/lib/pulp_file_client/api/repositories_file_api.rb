  ...
  class RepositoriesFileApi
    ...
    def add_role_with_http_info(file_file_repository_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.add_role",
    ...
    def create_with_http_info(file_file_repository, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(file_file_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedfileFileRepositoryResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(file_file_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def modify_with_http_info(file_file_repository_href, repository_add_remove_content, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.modify",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(file_file_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(file_file_repository_href, patchedfile_file_repository, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(file_file_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(file_file_repository_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def set_label_with_http_info(file_file_repository_href, set_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.set_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def unset_label_with_http_info(file_file_repository_href, unset_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.unset_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(file_file_repository_href, file_file_repository, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesFileApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
