...
module PulpContainerClient
  ...
  class RepositorySign < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PulpContainerClient::RepositorySign`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@future_base_path.nil? && @future_base_path.to_s.length < 1
        invalid_properties.push('invalid value for "future_base_path", the character length must be greater than or equal to 1.')
      end
    ...
    def future_base_path=(future_base_path)
      ...
      if future_base_path.to_s.length < 1
        fail ArgumentError, 'invalid value for "future_base_path", the character length must be greater than or equal to 1.'
      end
