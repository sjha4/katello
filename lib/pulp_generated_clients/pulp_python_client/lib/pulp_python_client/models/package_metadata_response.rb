...
module PulpPythonClient
  ...
  class PackageMetadataResponse < ApiModelBase
    # Cache value from last PyPI sync
    attr_accessor :last_serial
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PulpPythonClient::PackageMetadataResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] last_serial Value to be assigned
    def last_serial=(last_serial)
      if last_serial.nil?
        fail ArgumentError, 'last_serial cannot be nil'
      end
