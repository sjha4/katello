  ...
  class RepositoriesPythonVersionsApi
    ...
    def delete_with_http_info(python_python_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesPythonVersionsApi.delete",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RepositoriesPythonVersionsApi#delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def list_with_http_info(python_python_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesPythonVersionsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RepositoriesPythonVersionsApi#list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_with_http_info(python_python_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesPythonVersionsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RepositoriesPythonVersionsApi#read\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def repair_with_http_info(python_python_repository_version_href, repair, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesPythonVersionsApi.repair",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RepositoriesPythonVersionsApi#repair\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
