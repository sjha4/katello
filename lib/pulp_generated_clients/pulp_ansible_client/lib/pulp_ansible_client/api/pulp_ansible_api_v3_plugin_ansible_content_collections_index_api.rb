  ...
  class PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexApi
    ...
    def delete_with_http_info(distro_base_path, name, namespace, path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexApi.delete",
    ...
    def list_with_http_info(distro_base_path, path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(distro_base_path, name, namespace, path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(distro_base_path, name, namespace, path, patched_collection, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3PluginAnsibleContentCollectionsIndexApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
