  ...
  class RemotesRoleApi
    ...
    def add_role_with_http_info(ansible_role_remote_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.add_role",
    ...
    def create_with_http_info(ansible_role_remote, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(ansible_role_remote_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedansibleRoleRemoteResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"RemotesRoleApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(ansible_role_remote_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(ansible_role_remote_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(ansible_role_remote_href, patchedansible_role_remote, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(ansible_role_remote_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def set_label_with_http_info(ansible_role_remote_href, set_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.set_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def unset_label_with_http_info(ansible_role_remote_href, unset_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.unset_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(ansible_role_remote_href, ansible_role_remote, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesRoleApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
