...
module PulpAnsibleClient
  class RemotesGitApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedansibleGitRemoteResponseList'
    ...
    def set_label_with_http_info(ansible_git_remote_href, set_label, opts = {})
      ...
      # verify the required parameter 'ansible_git_remote_href' is set
      if @api_client.config.client_side_validation && ansible_git_remote_href.nil?
        fail ArgumentError, "Missing the required parameter 'ansible_git_remote_href' when calling RemotesGitApi.set_label"
      end
      ...
      # resource path
      local_var_path = '{ansible_git_remote_href}set_label/'.sub('{' + 'ansible_git_remote_href' + '}', CGI.escape(ansible_git_remote_href.to_s).gsub('%2F', '/'))
    ...
    def unset_label_with_http_info(ansible_git_remote_href, unset_label, opts = {})
      ...
      # verify the required parameter 'ansible_git_remote_href' is set
      if @api_client.config.client_side_validation && ansible_git_remote_href.nil?
        fail ArgumentError, "Missing the required parameter 'ansible_git_remote_href' when calling RemotesGitApi.unset_label"
      end
      ...
      # resource path
      local_var_path = '{ansible_git_remote_href}unset_label/'.sub('{' + 'ansible_git_remote_href' + '}', CGI.escape(ansible_git_remote_href.to_s).gsub('%2F', '/'))
