...
module PulpAnsibleClient
  class ContentCollectionDeprecationsApi
    ...
    def create_with_http_info(ansible_ansible_collection_deprecated, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ansible_ansible_collection_deprecated)
      ...
      new_options = opts.merge(
        :operation => :"ContentCollectionDeprecationsApi.create",
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedansibleAnsibleCollectionDeprecatedResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentCollectionDeprecationsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(ansible_ansible_collection_deprecated_href, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AnsibleAnsibleCollectionDeprecatedResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentCollectionDeprecationsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
