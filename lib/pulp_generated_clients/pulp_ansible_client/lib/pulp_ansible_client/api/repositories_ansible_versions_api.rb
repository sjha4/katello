  ...
  class RepositoriesAnsibleVersionsApi
    ...
    def delete_with_http_info(ansible_ansible_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAnsibleVersionsApi.delete",
    ...
    def list_with_http_info(ansible_ansible_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAnsibleVersionsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(ansible_ansible_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAnsibleVersionsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def rebuild_metadata_with_http_info(ansible_ansible_repository_version_href, ansible_repository_rebuild, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAnsibleVersionsApi.rebuild_metadata",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def repair_with_http_info(ansible_ansible_repository_version_href, repair, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAnsibleVersionsApi.repair",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
