  ...
  class PulpAnsibleApiV3CollectionsApi
    ...
    def delete_with_http_info(name, namespace, path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3CollectionsApi.delete",
    ...
    def list_with_http_info(path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3CollectionsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(name, namespace, path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3CollectionsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(name, namespace, path, patched_collection, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3CollectionsApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
