  ...
  class PulpAnsibleApiV3CollectionsVersionsApi
    ...
    def delete_with_http_info(name, namespace, path, version, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3CollectionsVersionsApi.delete",
    ...
    def list_with_http_info(name, namespace, path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3CollectionsVersionsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(name, namespace, path, version, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PulpAnsibleApiV3CollectionsVersionsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
