...
module PulpAnsibleClient
  ...
  class AnsibleCollectionVersionMarkResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PulpAnsibleClient::AnsibleCollectionVersionMarkResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] marked_collection Value to be assigned
    def marked_collection=(marked_collection)
      if marked_collection.nil?
        fail ArgumentError, 'marked_collection cannot be nil'
      end
