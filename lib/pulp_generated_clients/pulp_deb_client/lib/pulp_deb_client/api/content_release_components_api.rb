...
module PulpDebClient
  class ContentReleaseComponentsApi
    ...
    def create_with_http_info(deb_release_component, opts = {})
      ...
      if @api_client.config.client_side_validation && deb_release_component.nil?
        fail ArgumentError, "Missing the required parameter 'deb_release_component' when calling ContentReleaseComponentsApi.create"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(deb_release_component)
      ...
      new_options = opts.merge(
        :operation => :"ContentReleaseComponentsApi.create",
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginateddebReleaseComponentResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentReleaseComponentsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(deb_release_component_href, opts = {})
      ...
      if @api_client.config.client_side_validation && deb_release_component_href.nil?
        fail ArgumentError, "Missing the required parameter 'deb_release_component_href' when calling ContentReleaseComponentsApi.read"
      end
      # resource path
      local_var_path = '{deb_release_component_href}'.sub('{' + 'deb_release_component_href' + '}', CGI.escape(deb_release_component_href.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DebReleaseComponentResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentReleaseComponentsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
