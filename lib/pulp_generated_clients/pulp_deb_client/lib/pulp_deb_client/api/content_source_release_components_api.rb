...
module PulpDebClient
  class ContentSourceReleaseComponentsApi
    ...
    def create_with_http_info(deb_source_package_release_component, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(deb_source_package_release_component)

      # return_type
      return_type = opts[:debug_return_type] || 'DebSourcePackageReleaseComponentResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentSourceReleaseComponentsApi.create",
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginateddebSourcePackageReleaseComponentResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentSourceReleaseComponentsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(deb_source_package_release_component_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentSourceReleaseComponentsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
