  ...
  class RepositoriesAptVersionsApi
    ...
    def delete_with_http_info(deb_apt_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAptVersionsApi.delete",
    ...
    def list_with_http_info(deb_apt_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAptVersionsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(deb_apt_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAptVersionsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def repair_with_http_info(deb_apt_repository_version_href, repair, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesAptVersionsApi.repair",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
