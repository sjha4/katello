...
module PulpOstreeClient
  class ContentConfigsApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedostreeOstreeConfigResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentConfigsApi.list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContentConfigsApi#list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def read_with_http_info(ostree_ostree_config_href, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContentConfigsApi.read ...'
      end
      ...
      if @api_client.config.client_side_validation && ostree_ostree_config_href.nil?
        fail ArgumentError, "Missing the required parameter 'ostree_ostree_config_href' when calling ContentConfigsApi.read"
      end
      # resource path
      local_var_path = '{ostree_ostree_config_href}'.sub('{' + 'ostree_ostree_config_href' + '}', CGI.escape(ostree_ostree_config_href.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OstreeOstreeConfigResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentConfigsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContentConfigsApi#read\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
