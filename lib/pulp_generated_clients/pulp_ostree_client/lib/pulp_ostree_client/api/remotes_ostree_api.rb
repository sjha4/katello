  ...
  class RemotesOstreeApi
    ...
    def add_role_with_http_info(ostree_ostree_remote_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.add_role",
    ...
    def create_with_http_info(ostree_ostree_remote, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(ostree_ostree_remote_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedostreeOstreeRemoteResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(ostree_ostree_remote_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(ostree_ostree_remote_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(ostree_ostree_remote_href, patchedostree_ostree_remote, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(ostree_ostree_remote_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(ostree_ostree_remote_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def set_label_with_http_info(ostree_ostree_remote_href, set_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.set_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def unset_label_with_http_info(ostree_ostree_remote_href, unset_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.unset_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(ostree_ostree_remote_href, ostree_ostree_remote, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RemotesOstreeApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
