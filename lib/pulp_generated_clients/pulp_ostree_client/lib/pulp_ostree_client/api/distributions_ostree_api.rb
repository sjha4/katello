  ...
  class DistributionsOstreeApi
    ...
    def add_role_with_http_info(ostree_ostree_distribution_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.add_role",
    ...
    def create_with_http_info(ostree_ostree_distribution, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(ostree_ostree_distribution_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedostreeOstreeDistributionResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(ostree_ostree_distribution_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(ostree_ostree_distribution_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(ostree_ostree_distribution_href, patchedostree_ostree_distribution, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(ostree_ostree_distribution_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(ostree_ostree_distribution_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def set_label_with_http_info(ostree_ostree_distribution_href, set_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.set_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def unset_label_with_http_info(ostree_ostree_distribution_href, unset_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.unset_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(ostree_ostree_distribution_href, ostree_ostree_distribution, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsOstreeApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
