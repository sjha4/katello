...
module PulpOstreeClient
  class ContentObjectsApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedostreeOstreeObjectResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentObjectsApi.list",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContentObjectsApi#list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def read_with_http_info(ostree_ostree_object_href, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContentObjectsApi.read ...'
      end
      ...
      if @api_client.config.client_side_validation && ostree_ostree_object_href.nil?
        fail ArgumentError, "Missing the required parameter 'ostree_ostree_object_href' when calling ContentObjectsApi.read"
      end
      # resource path
      local_var_path = '{ostree_ostree_object_href}'.sub('{' + 'ostree_ostree_object_href' + '}', CGI.escape(ostree_ostree_object_href.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OstreeOstreeObjectResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentObjectsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContentObjectsApi#read\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
