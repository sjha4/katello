...
module PulpOstreeClient
  class ContentCommitsApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedostreeOstreeCommitResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentCommitsApi.list",
    ...
    def read_with_http_info(ostree_ostree_commit_href, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OstreeOstreeCommitResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentCommitsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
