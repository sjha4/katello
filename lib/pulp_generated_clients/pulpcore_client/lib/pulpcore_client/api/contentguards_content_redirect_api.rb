  ...
  class ContentguardsContentRedirectApi
    ...
    def add_role_with_http_info(content_redirect_content_guard_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.add_role",
    ...
    def create_with_http_info(content_redirect_content_guard, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(content_redirect_content_guard)

      # return_type
      return_type = opts[:debug_return_type] || 'ContentRedirectContentGuardResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(content_redirect_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedContentRedirectContentGuardResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(content_redirect_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(content_redirect_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(content_redirect_content_guard_href, patched_content_redirect_content_guard, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patched_content_redirect_content_guard)
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(content_redirect_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(content_redirect_content_guard_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(content_redirect_content_guard_href, content_redirect_content_guard, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsContentRedirectApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
