  ...
  class ContentguardsCompositeApi
    ...
    def add_role_with_http_info(composite_content_guard_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.add_role",
    ...
    def create_with_http_info(composite_content_guard, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(composite_content_guard)

      # return_type
      return_type = opts[:debug_return_type] || 'CompositeContentGuardResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(composite_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedCompositeContentGuardResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(composite_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(composite_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(composite_content_guard_href, patched_composite_content_guard, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patched_composite_content_guard)
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(composite_content_guard_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(composite_content_guard_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(composite_content_guard_href, composite_content_guard, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ContentguardsCompositeApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
