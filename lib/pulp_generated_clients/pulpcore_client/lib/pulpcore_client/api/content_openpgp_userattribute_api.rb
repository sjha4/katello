...
module PulpcoreClient
  class ContentOpenpgpUserattributeApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedOpenPGPUserAttributeResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentOpenpgpUserattributeApi.list",
    ...
    def read_with_http_info(open_p_g_p_user_attribute_href, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OpenPGPUserAttributeResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentOpenpgpUserattributeApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
