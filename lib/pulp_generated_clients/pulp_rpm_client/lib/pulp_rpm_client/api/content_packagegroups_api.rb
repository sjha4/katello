...
module PulpRpmClient
  class ContentPackagegroupsApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedrpmPackageGroupResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentPackagegroupsApi.list",
    ...
    def read_with_http_info(rpm_package_group_href, opts = {})
      ...
      if @api_client.config.client_side_validation && rpm_package_group_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_package_group_href' when calling ContentPackagegroupsApi.read"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RpmPackageGroupResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentPackagegroupsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
