  ...
  class DistributionsRpmApi
    ...
    def add_role_with_http_info(rpm_rpm_distribution_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.add_role",
    ...
    def create_with_http_info(rpm_rpm_distribution, opts = {})
      ...
      if @api_client.config.client_side_validation && rpm_rpm_distribution.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_distribution' when calling DistributionsRpmApi.create"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(rpm_rpm_distribution_href, opts = {})
      ...
      # verify the required parameter 'rpm_rpm_distribution_href' is set
      if @api_client.config.client_side_validation && rpm_rpm_distribution_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_distribution_href' when calling DistributionsRpmApi.delete"
      end
      # resource path
      local_var_path = '{rpm_rpm_distribution_href}'.sub('{' + 'rpm_rpm_distribution_href' + '}', CGI.escape(rpm_rpm_distribution_href.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedrpmRpmDistributionResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(rpm_rpm_distribution_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(rpm_rpm_distribution_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(rpm_rpm_distribution_href, patchedrpm_rpm_distribution, opts = {})
      ...
      # verify the required parameter 'rpm_rpm_distribution_href' is set
      if @api_client.config.client_side_validation && rpm_rpm_distribution_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_distribution_href' when calling DistributionsRpmApi.partial_update"
      end
      # verify the required parameter 'patchedrpm_rpm_distribution' is set
      if @api_client.config.client_side_validation && patchedrpm_rpm_distribution.nil?
        fail ArgumentError, "Missing the required parameter 'patchedrpm_rpm_distribution' when calling DistributionsRpmApi.partial_update"
      end
      # resource path
      local_var_path = '{rpm_rpm_distribution_href}'.sub('{' + 'rpm_rpm_distribution_href' + '}', CGI.escape(rpm_rpm_distribution_href.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(rpm_rpm_distribution_href, opts = {})
      ...
      # verify the required parameter 'rpm_rpm_distribution_href' is set
      if @api_client.config.client_side_validation && rpm_rpm_distribution_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_distribution_href' when calling DistributionsRpmApi.read"
      end
      # resource path
      local_var_path = '{rpm_rpm_distribution_href}'.sub('{' + 'rpm_rpm_distribution_href' + '}', CGI.escape(rpm_rpm_distribution_href.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(rpm_rpm_distribution_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def set_label_with_http_info(rpm_rpm_distribution_href, set_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.set_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def unset_label_with_http_info(rpm_rpm_distribution_href, unset_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.unset_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(rpm_rpm_distribution_href, rpm_rpm_distribution, opts = {})
      ...
      # verify the required parameter 'rpm_rpm_distribution_href' is set
      if @api_client.config.client_side_validation && rpm_rpm_distribution_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_distribution_href' when calling DistributionsRpmApi.update"
      end
      # verify the required parameter 'rpm_rpm_distribution' is set
      if @api_client.config.client_side_validation && rpm_rpm_distribution.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_distribution' when calling DistributionsRpmApi.update"
      end
      # resource path
      local_var_path = '{rpm_rpm_distribution_href}'.sub('{' + 'rpm_rpm_distribution_href' + '}', CGI.escape(rpm_rpm_distribution_href.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :"DistributionsRpmApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
