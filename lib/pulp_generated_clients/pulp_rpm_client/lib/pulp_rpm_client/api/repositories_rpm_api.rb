  ...
  class RepositoriesRpmApi
    ...
    def add_role_with_http_info(rpm_rpm_repository_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.add_role",
    ...
    def create_with_http_info(rpm_rpm_repository, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(rpm_rpm_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedrpmRpmRepositoryResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(rpm_rpm_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def modify_with_http_info(rpm_rpm_repository_href, repository_add_remove_content, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.modify",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(rpm_rpm_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def partial_update_with_http_info(rpm_rpm_repository_href, patchedrpm_rpm_repository, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.partial_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(rpm_rpm_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(rpm_rpm_repository_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def set_label_with_http_info(rpm_rpm_repository_href, set_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.set_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def sync_with_http_info(rpm_rpm_repository_href, rpm_repository_sync_url, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(rpm_repository_sync_url)
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.sync",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def unset_label_with_http_info(rpm_rpm_repository_href, unset_label, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.unset_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_with_http_info(rpm_rpm_repository_href, rpm_rpm_repository, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmApi.update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
