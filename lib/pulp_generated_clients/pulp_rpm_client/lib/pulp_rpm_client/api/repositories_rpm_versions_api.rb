  ...
  class RepositoriesRpmVersionsApi
    ...
    def delete_with_http_info(rpm_rpm_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmVersionsApi.delete",
    ...
    def list_with_http_info(rpm_rpm_repository_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmVersionsApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(rpm_rpm_repository_version_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmVersionsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def repair_with_http_info(rpm_rpm_repository_version_href, repair, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"RepositoriesRpmVersionsApi.repair",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
