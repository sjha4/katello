...
module PulpRpmClient
  class ContentPackageenvironmentsApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedrpmPackageEnvironmentResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentPackageenvironmentsApi.list",
    ...
    def read_with_http_info(rpm_package_environment_href, opts = {})
      ...
      if @api_client.config.client_side_validation && rpm_package_environment_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_package_environment_href' when calling ContentPackageenvironmentsApi.read"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RpmPackageEnvironmentResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentPackageenvironmentsApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
