...
module PulpRpmClient
  class ContentRepoMetadataFilesApi
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedrpmRepoMetadataFileResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentRepoMetadataFilesApi.list",
    ...
    def read_with_http_info(rpm_repo_metadata_file_href, opts = {})
      ...
      if @api_client.config.client_side_validation && rpm_repo_metadata_file_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_repo_metadata_file_href' when calling ContentRepoMetadataFilesApi.read"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RpmRepoMetadataFileResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"ContentRepoMetadataFilesApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
