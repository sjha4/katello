  ...
  class PublicationsRpmApi
    ...
    def add_role_with_http_info(rpm_rpm_publication_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.add_role",
    ...
    def create_with_http_info(rpm_rpm_publication, opts = {})
      ...
      if @api_client.config.client_side_validation && rpm_rpm_publication.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_publication' when calling PublicationsRpmApi.create"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(rpm_rpm_publication)
      ...
      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def delete_with_http_info(rpm_rpm_publication_href, opts = {})
      ...
      # verify the required parameter 'rpm_rpm_publication_href' is set
      if @api_client.config.client_side_validation && rpm_rpm_publication_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_publication_href' when calling PublicationsRpmApi.delete"
      end
      # resource path
      local_var_path = '{rpm_rpm_publication_href}'.sub('{' + 'rpm_rpm_publication_href' + '}', CGI.escape(rpm_rpm_publication_href.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaginatedrpmRpmPublicationResponseList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_roles_with_http_info(rpm_rpm_publication_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.list_roles",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def my_permissions_with_http_info(rpm_rpm_publication_href, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.my_permissions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def read_with_http_info(rpm_rpm_publication_href, opts = {})
      ...
      # verify the required parameter 'rpm_rpm_publication_href' is set
      if @api_client.config.client_side_validation && rpm_rpm_publication_href.nil?
        fail ArgumentError, "Missing the required parameter 'rpm_rpm_publication_href' when calling PublicationsRpmApi.read"
      end
      # resource path
      local_var_path = '{rpm_rpm_publication_href}'.sub('{' + 'rpm_rpm_publication_href' + '}', CGI.escape(rpm_rpm_publication_href.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RpmRpmPublicationResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['remoteUserAuthentication']

      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.read",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def remove_role_with_http_info(rpm_rpm_publication_href, nested_role, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PublicationsRpmApi.remove_role",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
