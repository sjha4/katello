...
const ContentViewFilterDetailsHeader = ({ cvId, filterId, details, showAffectedRepos, setShowAffectedRepos }) => {
  const {
  ...
  return (
    <>
      ...
      <GridItem span={3} style={{float: 'right'}}>
        <AffectedRepositorySelection cvId={cvId} filterId={filterId} setShowAffectedRepos={setShowAffectedRepos} />
      </GridItem>
      <GridItem span={10}>
        <Split hasGutter>
          <SplitItem>
